...
function __scheme_get_definition \
    ...
    switch $scheme_name
        ...
        case modus
            # Color palette
            set -l background 1e1e1e
            set -l foreground C4C4C4
        ...
        case molokai
            # Color palette
            set -l background 1b1e1b
            set -l current_line 232526
            set -l selection BCA3A3
            set -l foreground f8f8f2
            set -l comment 465457
            set -l cyan 66d9ef
            set -l green a6e22e
            set -l orange 7070F0
            set -l purple AE81FF
            ...
            set -g scheme_color_param $foreground
            set -g scheme_color_comment $comment
            set -g scheme_color_operator $red
            set -g scheme_color_escape $purple
            set -g scheme_color_cwd $green
            set -g scheme_color_cwd_root $red
            set -g scheme_color_autosuggestion $comment
        ...
        case oxocarbon-dark
            # Color palette
            set -l foreground FAFAFA
            set -l selection 37474F
            set -l teal 3ddbd9
            set -l flamingo ff7eb6
            set -l magenta be95ff
            set -l pink ee5396
            set -l red FFAB91
            set -l peach 82cfff
            set -l green 42be65
        ...
        case rosepine
            ...
            set -l selection 2a283e
            set -l teal 9ccfd8
            set -l flamingo ebbcba
            set -l magenta c4a7e7
            set -l pink eb6f92
            set -l red eb6f92
            set -l peach f6c177
            set -l green 31748f
